 ...
 *
 * <p>Реализует {@link CommentQueryPort}, {@link CommentCommandPort}.
...
class CommentService implements CommentQueryPort, CommentCommandPort {
    ...
    CommentService(
        ...
        PostContextPort postContextPort,
        AuthorLookupPort authorLookupPort
    ) {
        this.commentRepository = commentRepository;
        this.commentMapper = commentMapper;
        this.commentValidator = commentValidator;
        this.postContextPort = postContextPort;
        this.authorLookupPort = authorLookupPort;
    }
